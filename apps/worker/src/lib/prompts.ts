...
const DESCRIPTOR_POOL: Record<DescriptorRole, readonly string[]> = {
  concept: [
    ...
    'cathedral', 'workshop', 'arcade', 'monastery', 'promenade', 'opera house',
    ...
    'bamboo grove', 'magnolia grove', 'lavender field', 'sunflower field',
    'heather moorland', 'vineyard', 'tea plantation', 'wildflower meadow',
    ...
    'hedge maze', 'parade', 'ballroom', 'carnival', 'regatta', 'lantern festival',
    'aviary', 'puppet theatre', 'flower market', 'fish market',
    ...
    'light installation', 'ice sculpture', 'wind chimes',
  ],
  ...
  location: [
    ...
    'river bend', 'waterfront', 'spa town', 'hilltop village',
    'cliff dwelling', 'floating village', 'boreal lakeshore',
    ...
    'fountain plaza', 'cobblestone street',
    'canal district', 'old town', 'fishing village', 'mountain monastery',
    'desert oasis', 'flooded forest', 'coral shallows',
    ...
    'geyser basin', 'thatched village', 'plantation veranda',
    'plane-tree boulevard', 'dune sea', 'redwood forest', 'savanna plain',
  ...
  state: [
    ...
    'patinated', 'hand-painted', 'gilded', 'carved', 'filigreed', 'layered',
  ...
  lighting: [
    ...
    'firelight flicker', 'candlelit warmth', 'gaslight haze', 'neon reflections',
    'bioluminescent glow', 'shaft of light through clouds', 'rainbow prism light',
    'eclipse shadow', 'polar twilight', 'tropical noon glare',
    'autumn leaf-filtered light', 'glacial blue light', 'campfire embers',
    'harvest moon glow', 'frost-blue dusk', 'distant fireworks burst',
...
const DIAMOND_DESCRIPTOR_POOL: Record<DescriptorRole, readonly string[]> = {
  ...
  concept: [
    ...
    'whale breaching offshore', 'pelican on a piling',
    ...
    'a watermill by a stream', 'olive tree on a hillside',
    ...
    'teapot and cups', 'flower cart', 'a watering can among flowers',
    ...
    'tulip field in rows', 'sunflower field', 'a castle on a hill',
    'harbour with fishing boats', 'beach scene with umbrellas',
    'a tiger in tall grass', 'a misty pine forest', 'a river through autumn woods',
    ...
    'old town plaza', 'carnival parade', 'alpine chalet in snow',
    'botanical glasshouse', 'desert caravan with camels', 'monsoon street scene',
    ...
    'church steeple with cottages', 'a coastal village at dusk',
  ...
  location: [
    ...
    'boardwalk', 'pier', 'village square', 'mountain pass',
    'riverbank', 'desert vista', 'poppy field', 'parkland',
    'clifftop', 'pine ridge', 'canal side', 'woodland path',
    'coral cove', 'moonlit bay', 'bluebell wood', 'herb garden',
    'oak woodland', 'lagoon island', 'rose garden', 'tropical balcony',
    'monastery garden', 'thatched-village edge',
    'tide pools', 'reed-edged pond', 'azalea garden',
    'savanna kopje', 'jungle clearing', 'wisteria walk',
    'tiled rooftop view', 'cobbled lane', 'cypress avenue',
    'baobab plain', 'mountain tarn', 'forest stream',
  ...
  lighting: [
    ...
    'golden afternoon glow', 'pale winter light', 'amber lamp light',
...
const DIAMOND_ACCENT_POOL: readonly string[] = [
  ...
  'striped parasols', 'hanging baskets', 'fairy lights',
  ...
  'a wooden fence', 'winding paths', 'haystacks',
